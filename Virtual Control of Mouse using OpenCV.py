...
scroll_threshold = 450 # Adjust as needed
...
while True:
    ...
    for id, landmark in enumerate(landmarks):
        ...
        if id == 4: # Thumb tip
            ...
            if abs(y_index - thumb_y) < 10 and abs(x_index - thumb_x) < 10:
                pyautogui.click()
                print("Left Click!")
...
# Check if index and middle fingers are close for right click
            if (
                abs(x_index - middle_finger_x) < 10
                and abs(y_index - middle_finger_y) < 10
                ):
...
# Check for scrolling up gesture
            if (
                landmarks[5].y < landmarks[9].y
                and landmarks[9].y < landmarks[13].y
                and landmarks[13].y < landmarks[17].y
            ):
                pyautogui.scroll(scroll_threshold) # Scroll up
# Check for scrolling down gesture
            elif (
                landmarks[5].y > landmarks[9].y
                and landmarks[9].y > landmarks[13].y
                and landmarks[13].y > landmarks[17].y
                ...
                pyautogui.scroll(-scroll_threshold) # Scroll down
